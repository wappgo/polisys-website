...
const ReadMoreImg = `${process.env.PUBLIC_URL}assets/aboutUs/about_us_read_more.svg`
const Image1 = `${process.env.PUBLIC_URL}assets/aboutUs/about_us_sec2_img.png`
const Section2 = () => {
  return (
    <div>
