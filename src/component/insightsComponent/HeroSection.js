...
const ArrowImage = `${process.env.PUBLIC_URL}assets/insights/arrow-right-circle.svg`
  ...
  return (
    <div>
        ...
        <div className="row w-100">
          ...
          <p onClickCapture={()=>router("/contact-us")} className="insights-hero-lets-talk">
          Let’s Talk
          </p>
          <img onClickCapture={()=>router("/contact-us")} src={ArrowImage}/>
          </div>
          <div className="hero-contact-btn">
              <button onClickCapture={()=>router("/contact-us")} className="insights-hero-btn">Contact</button>
            </div>
          </div>
        </div>
      </div>
