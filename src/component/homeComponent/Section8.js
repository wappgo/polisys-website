    ...
    <div className="sectionn2-container">
      <div className="sectionn2">
        <div className="row dareeymar">
          <div className="col-lg-4">
            <div className="sectionn2-left-container">
              ...
              <h2 className="darkeyesuhe">
                Ensuring Comprehensive Monitoring and Management for Effective
                Governance.
              </h2>
              <p className="darkpar">
                Leading the state requires constant vigilance and effective
                management. The Dark Eye by Polisys offers a 360-degree
                monitoring solution to keep you informed of all events, both
                good and bad. Our platform supports the Chief Minister’s office
                in maintaining control and fostering effective governance.
              </p>
              <div className="mobile-view-align contdiv">
                <button
                  onClickCapture={() => router("/contact-us")}
                  className="contact-btn contbtn"
                >
                  Contact Us
                </button>
              </div>
          ...
          <div className="col-lg-8 dareeymar">
            {/* <Swiper
              slidesPerView={'auto'}
              // centeredSlides={true}
              spaceBetween={30}
