...
const Footer = () => {
  ...
  return (
    ...
    <hr className="faded_divider_hr" />
      <div className="row">
        <div className="col-lg-4 col-md-12 col-sm-12  footerlogo">
        ...
        <div className="col-lg-2 col-md-4 col-sm-12 reachat">
          <div>
            <h3>Reach Us At</h3>

            <div className="d-flex footeral">
        ...
        <div className="col-lg-2 col-md-4 col-sm-12 importlink">
          <div>
        ...
        <div className="col-lg-4 col-md-4 col-sm-12 importlink">
